...
# Neu chay tren Expo Go thuan, chi dung de test JS/UI gioi han.
# NotificationListener/native behavior khong day du trong Expo Go thuan.
# npm run start
# npx expo start --lan --clear
# npx expo start --tunnel --clear

# Project nay co expo-dev-client va native NotificationListener.
...
# 3. Chay lai: npx expo start --dev-client --lan --clear
